      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text('About the Architecture', style: TextStyle(fontSize: 25,color: Colors.black54), textAlign: TextAlign.justify,),
            Padding(
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 30),
              child: Text('Swipe Down', style: TextStyle(fontSize: 25,color: Colors.black45), textAlign: TextAlign.justify,),
            ),
          ],
        ),
      ),
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text('About the Developers', style: TextStyle(fontSize: 25,color: Colors.black54), textAlign: TextAlign.justify,),
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 30),
